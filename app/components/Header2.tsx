      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          {heroImage ? (
            ...
            <div className="relative aspect-square w-full max-w-md mx-auto md:mx-0 md:ml-auto border-2 border-dashed rounded-lg flex items-center justify-center" style={{ borderColor: textColor, opacity: 0.3 }}>
